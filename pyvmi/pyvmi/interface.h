...
/* LibVMI interface definitions for CFFI / Python integration.
 * Started from libvmi.h, and simplified to work with CFFI.
 *
 * Author: Bryan D. Payne (bdpayne@acm.org)
 */
...
#define MAX_PAGE_CACHE_SIZE ...

typedef uint32_t vmi_mode_t;

/* These will be used in conjuction with vmi_mode_t variables */

#define VMI_AUTO ...  /**< libvmi should detect what to monitor or view */

#define VMI_XEN ...  /**< libvmi is monitoring a Xen VM */

#define VMI_KVM ...  /**< libvmi is monitoring a KVM VM */

#define VMI_FILE ...  /**< libvmi is viewing a file on disk */

#define VMI_INIT_PARTIAL ...  /**< init enough to view physical addresses */

#define VMI_INIT_COMPLETE ...  /**< full initialization */

#define VMI_INIT_EVENTS ...  /**< init support for memory events */

#define VMI_INIT_SHM_SNAPSHOT ...  /**< setup shm-snapshot in vmi_init() if the feature is activated */

#define VMI_CONFIG_NONE ...  /**< no config provided */

#define VMI_CONFIG_GLOBAL_FILE_ENTRY ...  /**< config in file provided */

#define VMI_CONFIG_STRING ...  /**< config string provided */

#define VMI_CONFIG_GHASHTABLE ...  /**< config GHashTable provided */

#define VMI_INVALID_DOMID ...  /**< invalid domain id */
